...
fig02 = px.pie(df, values="budget",names='code_name')
fig02.update_traces(textposition='inside', textinfo='percent+label', hole=.3)
fig02.update_layout(margin = dict(t=0, l=0, r=0, b=0))
